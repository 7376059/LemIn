...
/*   Updated: 2020/03/15 19:35:11 by efriesen         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void			duplicate_vertices_in_shortest_way(t_graph *graph,
		int **links, int **matrix);
void			modify_and_remove_edges(int **links, int **matrix,
		int size_matrix);
